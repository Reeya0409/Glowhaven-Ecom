...
?>
    <tr class='text-center'>
        ...
        <th><?php  echo $brand_title; ?></th>
            <td><a href='index.php?edit_brands=<?php echo"$brand_id"  ?>' class='text-dark'><i class='fa fa-solid fa-pen-to-square'></i></a></td>
            <td><a href='index.php?delete_brands=<?php echo"$brand_id"  ?>' type="button" class="text-dark " data-toggle="modal" data-target="#exampleModal"><i class='fa fa-solid fa-trash'></i></a></td>
    </tr>
